...
define -2 gui.accent_color = u'#0099cc'

define -2 gui.idle_color = u'#888888'

define -2 gui.idle_small_color = u'#aaaaaa'

define -2 gui.hover_color = u'#66c1e0'

define -2 gui.selected_color = u'#ffffff'

define -2 gui.insensitive_color = u'#8888887f'

define -2 gui.muted_color = u'#003d51'
define -2 gui.hover_muted_color = u'#005b7a'

define -2 gui.text_color = u'#ffffff'
define -2 gui.interface_text_color = u'#ffffff'
