label part1_home:
    ...
    mysterious "После того, как прозвучал сигнал тревоги, они напали на нашу базу, и пока у нас были силы сражаться, мне сказали отправиться в 2019 год и придумать что-нибудь, что остановит их прибытие в 2075 году."

    mysterious "Но они раскусили наш план и сами отправились в 2019 год, чтобы остановить меня, но, как ты понимаешь, им это не удалось, и тогда они решили пойти ещё дальше и найти меня ещё молодым..."
    ...
    mysterious "Это моя оружейная комната, в ней хранятся различные виды всевозможного оружия, в том числе одно от захватчиков."
