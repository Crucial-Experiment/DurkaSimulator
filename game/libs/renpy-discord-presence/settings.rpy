...
define discord.application_id = "906255281477013604"

#####################################################################################################################################

# State of the Presence upon the game's launch and return to the main menu..
define discord.main_menu_state = { "details" : _("В главном меню"), "large_image" : "big_logo"}

# State of the Presence when the game is started.
define discord.start_state = { "details" : _("Читает историю"), "large_image" : "big_logo"}
